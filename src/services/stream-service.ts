...
export async function getCameras(): Promise<Camera[]> {
  ...
  const streamUrl = 'https://ott1.hdlatam.tv/live/dahua_indoorH3A/playlist_dvr.m3u8'; // Updated Stream URL
...
export async function getStreamUrlForTimestamp(
  ...
  // Return the specific recording URL for timestamp searches
  return 'https://ott1.hdlatam.tv/live/dahua_indoorH3A/playlist_dvr.m3u8'; // Updated Recording URL
}
