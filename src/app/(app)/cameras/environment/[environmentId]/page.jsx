// src/app/(app)/cameras/environment/[environmentId]/page.jsx
"use client";
...
export default function EnvironmentCameraListPage() {
  ...
  const { data: cameras, isLoading: isLoadingCameras, isError: isErrorCameras, error: errorCameras } = useQuery({
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Alert variant="destructive" className="rounded-lg shadow-md">
         <WifiOff className="h-5 w-5"/>
          ...
          <AlertDescription>
            {isError ? `Failed to load cameras for this environment. ${error?.message}` : 'Environment not found.'}
