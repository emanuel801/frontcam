// src/app/(app)/cameras/page.jsx -> Now serves as the Environment List page
"use client";
...
export default function EnvironmentListPage() {
  const { data: environments, isLoading, isError, error } = useQuery({ // Use Environment type
      ...
      <div className="container mx-auto px-4 py-8">
        <Alert variant="destructive" className="rounded-lg shadow-md">
         <WifiOff className="h-5 w-5"/>
          ...
          <AlertDescription>
            Failed to load environments. Please check your connection and try again. {error?.message}
          </AlertDescription>
        </Alert>
      </div>
    );
